export const GLOSSARY = [
    ...
    {
        term: 'Ecology',
        definition: 'The study of the relationships between living organisms, including humans, and their physical environment; it seeks to understand the vital connections between plants and animals and the world around them.',
    ...
    },
    {
        ...
        definition: 'Also known as habitat corridors or wildlife corridors, these wildlife areas are designed to keep local, migratory animal species from the encroaching human population in regions where human-wildlife interactions are unavoidable.',
    ...
    {
        term: 'CBD',
        definition: 'The international legal instrument for "the conservation of biological diversity, the sustainable use of its components and the fair and equitable sharing of the benefits arising out of the utilization of genetic resources" that has been ratified by 196 nations.',
    ...
    {
        term: 'Chromista',
        definition: 'A biological kingdom comprised of unicellular or multicellular eukaryotic species such as algae, diatoms, oomycetes, and protozoans.',
    ...
    {
        term: 'HIPPO',
        definition: 'In 2005, E.O. Wilson coined the acronym HIPPO to summarize threats to biodiversity in order of descending importance. H=Habitat Loss, I=Invasive Species, P=Pollution, P=Human Population, and O=Overharvesting.',
        source: 'National Park Service'
    },
    {
        term: 'E.O. Wilson',
        definition: 'A biologist and author who conducted pioneering work on biodiversity, insects and human nature — and won two Pulitzer Prizes along the way.',
    ...
    {
        term: 'Deforestation',
        definition: 'The removal or thinning of forests for lumber, or to use the land where the trees stood for crops, grazing, extraction (mining, oil, or gas), or development.',
        source: 'National Geographic'
    },
    {
