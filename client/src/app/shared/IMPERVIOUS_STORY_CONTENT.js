...
import { URBAN_RURAL_POPULATIONS } from './URBAN_RURAL_POPULATIONS';
import flood from '../media/flood.jpg';
...
import soilErosion from '../media/soil-erosion.jpg';
import uhi from '../media/uhi.jpg';

// SOLUTIONS MEDIA
import { EDUCATION_CLIMATE } from './EDUCATION_CLIMATE';
import greenCityTwo from '../media/green-city-2.jpg';
import greenBuilding from '../media/green-building.jpg';
import bioswale from '../media/bioswale.jpg';
import riparianBuffer from '../media/riparian-buffer.jpg';
import pervious from '../media/pervious.jpg';
import perviousConcrete from '../media/pervious-concrete.jpg';
import sandhillCrane from '../media/sandhill-crane.jpg';
import ecoServices from '../media/ecosystem-services.png';
import greenBuildingTwo from '../media/green-building2.jpg';
import leed from '../media/leed.png';
import mixedUse from '../media/mixed-use-development.jpg';
import fairCity from '../media/fair-city.png';
...
export const IMPERVIOUS_STORY_INTRO_CONTENT = [
    ...
    },
    {
        ...
        media: {
            image: flood,
            video: null,
            alt: 'a flooded road with a warning sign that says road closed by flood',
            source: 'Phillip Flores',
            caption: null,
            chart: null,
            chartTitle: null,
            chartSubtitle: null,
    ...
    },
    {
        ...
        text: {
            ...
            body: [
                'As the human population continues to grow, the expansion of cities and towns requires construction of new roads, neighborhoods, shopping centers, and walkways. These urban and suburban areas are often characterized by low-density housing, increased reliance on automobiles for transportation, and the destruction and fragmentation of wildlife habitat.'
            ]
        },
        media: {
            index: 2,
    ...
    },
    {
        ...
        text: {
            header: '',
            body: [
                'Throughout modern history, humans have trended overwhelmingly toward living in urban areas.',
        ...
        media: {
            ...
            caption: null,
            chart: true,
            chartTitle: 'Urban & Rural Population Distribution',
            chartSubtitle: 'Global Population (1960)',
            chartType: 'line',
            chartData: null,
            chartTicks: null,
            chartMobileData: URBAN_RURAL_POPULATIONS.filter(
                (item) => item.name === 1960
            ).filter(
                (item) => item.name % 5 === 0
            )
    ...
    },
    {
        ...
        media: {
            ...
            chart: true,
            chartTitle: 'Urban & Rural Population Distribution',
            chartSubtitle: 'Global Population (1960-2007)',
            chartType: 'line',
            chartData: null,
            chartTicks: null,
            chartMobileData: URBAN_RURAL_POPULATIONS.filter(
    ...
    },
    {
        ...
        media: {
            ...
            chart: true,
            chartTitle: 'Urban & Rural Population Distribution',
            chartSubtitle: 'Global Population (1960-2020)',
            chartType: 'line',
            chartData: null,
            chartTicks: null,
            chartMobileData: URBAN_RURAL_POPULATIONS.filter((item) => item.name % 5 === 0)
        },
    },
    {
        index: 6,
    ...
    },
    {
        ...
        media: {
            ...
            chart: true,
            chartTitle: 'Trends in Urban, Suburban, and Rural Living',
            chartSubtitle: '% of U.S. Population (1970-2018)',
            chartType: 'bar',
...
export const IMPERVIOUS_STORY_THREATS_CONTENT = [
    ...
    },
    {
        ...
        text: {
            ...
            body: [
                'In some parts of the world, especially rural and arid regions, groundwater is the only reliable source of fresh water. In the United States alone, groundwater provides roughly half of the population with drinking water. If you have a well, that well is drilled deep into the ground, below the water table, where it can access and deliver groundwater to your home.',
    ...
    },
    {
        ...
        text: {
            header: '',
            body: [
                'Groundwater is also used extensively in agriculture. The ability to extract groundwater for irrigation can be the difference between a reliable harvest or crop failure due to drought. This becomes increasingly important as the global population continues to expand, and our dietary needs along with it.',
            ],
    ...
    },
    {
        ...
        media: {
            image: soilErosion,
            video: null,
            alt: 'dry and cracked soil with sparse grass resulting from nearby overdevelopment',
            source: 'Dave Lowe',
            caption: null,
            chart: null,
            chartTitle: null,
    ...
    },
    {
        ...
        media: {
            image: null,
            video: 'uAMniWJm2vo?si=z1rgE4Mr0D8eY6GF',
            alt: null,
            source: "Dr. Elaine's Soil Food Web School",
            caption: null,
            chart: null,
            chartTitle: null,
            chartSubtitle: null,
...
export const IMPERVIOUS_STORY_SOLUTIONS_CONTENT = [
    ...
    },
    {
        ...
        media: {
            image: ecoServices,
            video: null,
            alt: 'sketches depicting various ecosystem services such as clean water and pollination',
    ...
    },
    {
        ...
        media: {
            image: leed,
            video: null,
            alt: 'round logo depicting three leaves, with the text Leed Certified, U.S. Green Building Council',
    ...
    },
    {
        ...
        media: {
            image: mixedUse,
            video: null,
            alt: 'German city street depicting mixed-use development, with people biking and businesses alongside businesses and homes.',
            source: 'Roman Kraft',
            caption: null,
            chart: null,
            chartTitle: null,
    ...
    },
    {
        ...
        media: {
            ...
            source: 'City of Moonee Valley, Melbourne, AU',
            caption: null,
            chart: null,
            chartTitle: null,
            chartSubtitle: null,
