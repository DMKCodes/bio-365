export const IMPERVIOUS_STORY_MAIN_CONTENT = [
    ...
    },
    {
        ...
        body: [
            ...
            'According to data from the U.N. Population Division, in 1960, the rural population was twice that of the urban population.'
        ]
    },
    {
        header: '',
    ...
    },
    {
        ...
        body: [
            "These benefits can keep us connected and improve our quality of life, but they often come at an unsustainable price. The low-density, suburban style of living requires more roads, parking lots, and single-family homes—all impervious surfaces."
        ]
    },
    {
        header: '',
...
export const IMPERVIOUS_STORY_SOLUTIONS_CONTENT = [
    {
        ...
        body: [
            'Creating and maintaining parks and green spaces in urban areas provides habitat and corridors for native species, reduces the Urban Heat Island effect, and improves air and water quality.',
        ]
    },
    {
        header: 'Green roofs',
        body: [
            'Growing vegetation on rooftops reduces stormwater runoff, improves insulation, and creates new habitat for various species. Green roofs can act as stepping stones for wildlife, especially birds and insects, as they pass across urban environments.'
        ]
    },
    {
    ...
    },
    {
        ...
        body: [
            'Permeable, or pervious, materials are designed to allow water to pass through them, thereby reducing surface runoff and allowing for groundwater recharge. This can help in maintaining natural water cycles and reduce the stress on local ecosystems.'
        ]
    },
    {
    ...
    },
    {
        ...
        link: 'https://www.researchgate.net/publication/269092054_Examinations_of_Pervious_Concrete_and_Porous_Asphalt_Pavements_Performance_for_Stormwater_Management_in_Northern_Climates'
    },
    {
        header: '3. Habitat restoration',
        body: [
            "Sometimes, it's just as important to fix what we've already broken as it is to add new features to our urban environments. Rehabilitating degraded areas by reintroducing native plants and creating conditions that support native wildlife can be instrumental in increasing biodiversity. This includes wetland restoration, which is particularly effective in improving water quality and providing new habitat for a diverse range of species."
        ]
    },
    {
        header: 'Spotlight: The Vermont Partners Program',
        body: [
            'In many cases, habitat restoration is a partnership between private landowners and government organizations. Cost-share programs offset the financial burden of biodiversity conservation, allowing the owners of the land to act as stewards without the need for direct government intervention.',
        ...
        link: 'https://www.fws.gov/project/habitat-restoration'
    },
    {
        header: '4. Education and community engagement',
        body: [
            'Informing and involving the community in biodiversity conservation efforts can be very effective. When people understand the value of biodiversity, they are more likely to support and engage in conservation initiatives.'
        ]
    },
    {
        header: '5. Government regulation and incentives',
        body: [
    ...
    },
    {
        ...
        body: [
            ...
            'Adopting green building codes and standards is another approach that ensures construction projects meet sustainability criteria. This includes energy efficiency, water conservation, and the use of renewable building materials',
            "One example is Leadership in Energy and Environmental Design, or LEED, a green building certification program used across the globe."
        ],
        link: 'https://www.usgbc.org/leed/benefits-leed',
        ...
        quoteSource: 'United States Green Building Council'
    },
    {
        header: 'Spotlight: Mixed-use development',
        body: [
            "While limiting impervious coverage is an effective tool, it's also important to scrutinize how urban areas can best be developed to protect the broader environment. A concept called mixed-use development, sometimes referred to as the '15-Minute City', is an urban planning concept that combines residential, commercial, and recreational areas with public transit to create hubs where residents can meet all their basic needs by traveling only a short distance. This concept has taken many forms in recent years: "
        ]
    },
    {
        header: '',
        body: [
            "In 2016, Copenhagen adopted a '5 minutes to everything' model, which requires a maximum 5-minute walk to all amenities and public transit. Their goal was to ensure tight-knit and varied neighborhoods, encouraging the use of bicycles and public transit over private automobiles. Copenhagen went one step further by incorporating energy forms including district heating and cooling, geothermal energy, and solar cells, thus making their urban areas CO2-neutral."
        ],
    ...
    },
    {
        ...
        body: [
            'Providing tax credits, grants, or low-interest loans for green development encourages builders and developers to implement more sustainable practices. For example, a developer might receive a tax credit for choosing permeable pavement or preserving a fixed percentage of a property as green space.'
        ]
    },
    {
    ...
    },
    {
        ...
        body: [
            ...
            'Remember, advocating for your beliefs, whether online or in person, is not about having the loudest voice. Be consistent, do the research, and share information with confidence. If we stay focused on raising awareness and affecting change, the results will come in time.'
        ]
    },
    {
        header: 'Contact your officials',
        body: [
            ...
            "In the modern day, it can feel like we don't have a voice in government—like politicians bend to the will of powerful business interests, often at the expense of our planet and of social equality. These are ideas that must be challenged at every opportunity. Corruption and ignorance thrive when they're not confronted by the truth.",
    ...
    },
    {
        ...
        body: [
            'In the late 1970s, the Love Canal neighborhood in Niagara Falls, New York found itself in the national spotlight. The Hooker Chemical Company had sold the 16-acre site, once a planned model community, to the local school district for $1 in 1953. Two schools were built on the property by 1955.'
        ]
    },
    {
        header: '',
    ...
    },
    {
        ...
        body: [
            ...
            "Over a 2-year period, Lois Gibbs rallied homeowners, organized protests and rallies, and navigated a protracted legal battle in the face of resistance from Occidental Petroleum, the Hooker Chemical Co.'s parent company, as well as the local and state governments. She didn't give up until her campaign gained national attention.",
            "Lois Gibbs's advocacy for her family and community eventually led to the evauation and relocation of families affected by the toxic waste, and played a significant role in the creation of the Comprehensive Environmental Response, Compensation, and Liability Act, commonly known as the Superfund Act, in 1980."
        ],
